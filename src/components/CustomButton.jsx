    ...
    return (
        <div className='relative'>
            <svg width={width} height={height} viewBox="0 0 238 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <mask id="mask0_47_2" style={{ "maskType": 'alpha' }} maskUnits="userSpaceOnUse" x="1" y="1" width="27" height="55">
                ...
                <mask id="mask1_47_2" style={{ "maskType": 'alpha' }} maskUnits="userSpaceOnUse" x="210" y="1" width="27" height="55">
                    <g clipPath="url(#clip1_47_2)">
