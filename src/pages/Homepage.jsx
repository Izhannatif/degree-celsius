...
const Homepage = () => {
    ...
    return (
        <section className='w-full h-full '>
            ...
            <div className='h-full md:h-[80vh] w-full flex flex-col md:flex-row  justify-around items-center gap-20 px-5 md:px-10'>
                <div className='w-1/2 flex flex-col md:flex-row pl-10'>
                    <div className='h-full md:h-[60vh] w-full md:w-1/2  petal-1-bg bg-contain'>
                    </div>
                    <div className="h-full md:h-[60vh] w-full md:w-1/2 rounded-2xl petal-2-bg bg-contain">
                    </div>
                </div>
                <div className='w-full md:w-1/2 flex justify-center items-center h-full p-5'>
                    <div className='h-full md:h-[80vh] w-full flex items-start flex-col justify-center text-start'>
                        <p className='font-medium p-2 text-fire-brick'>Featured Comics</p>
                        <p className='text-3xl md:text-5xl font-extrabold w-3/4 pt-2 pb-6'>Announcing Gooodyng: The Polymath</p>
                                        ...
                                        <div className="">
                                            {
                                                chapter.poster_image_url ?
                                                    ...
                                                    :
                                                    <div className='h-[50vh] min-w-[30vw] bg-matte-black mx-2'>
                                                        <div className='relative h-10 w-10 -top-5 bg-tacao right-5 rotate-45'></div>
                                                        <div className='h-full font-demibold text-3xl text-wrap flex items-center text-light px-5 '>More Chapters <br />Coming Soon.</div>
                                                    </div>
                                            }
                                        </div>
                                        <div className="p-2">
                                        ...
                                        <div className="overflow-hidden">
                                            {
                                                character.character_image2_url ?
                                                    <div className=''>
                                                        ...
                                                        <img src={character.character_image2_url} className="h-[60vh] object-cover" />
                                                    </div>

                                                    :
                                                    <div className=''>
                                                        <div className='relative h-10 w-10 bg-light top-5 right-0 rotate-45'></div>
                                                        <div className=' h-[60vh] bg-matte-black mx-5 font-demibold text-3xl text-wrap flex items-center text-light p-5 justify-center'>Introducing more characters soon.</div>
                                                    </div>
                                            }
                                        </div>
                                        <br />
