                ...
                <section
                    ...
                    <div className='header-div h-[90vh] w-full flex items-center justify-center bg-matte-black flex-col px-1'>
                        <motion.p
                            ...
                            className='text-tacao text-md font-demibold pb-2'>Welcome to Degree Celsius 👋</motion.p>
                        <motion.h1
                            initial={{ scale: 0.5 }}
                            animate={{ scale: 1 }}
                            transition={{ type: 'spring', stiffness: 70, damping: 20 }}
                            className='text-4xl md:text-7xl font-extrabold text-light text-center pb-10'>Gaze upon
                            <br />a horrific future</motion.h1>
                    ...
                    <div className='h-full md:h-[90vh] w-full flex flex-col-reverse md:flex-row  justify-center items-center gap-5 md:gap-20 px-5 md:px-10 '>
                        ...
                        animate={{ x: '0%' }}
                        transition={{ type: 'spring', stiffness: 70, damping: 20 }}
                        className='w-full md:w-1/2 flex flex-col md:pl-10 items-center justify-center pb-10 md:pb-0 gap-2'>
                        ...
                        animate={{x:'0%'}}
                        transition={{type:'spring', stiffness:70, damping:20}}
                        className='w-full md:w-1/2 flex justify-center items-center h-full p-5'>
